...
OUTPUT_FP = "./simulatedWeather1.csv"
NOISE_PROB = 0.3
...
def writeData(fp,date,time,temp,rain,comment):
    ...
    #print date+','+str(time)+','+str(temp)+','+str(rain)
...
def main():
    ...
    for year in YEARS:
        ...
        for index,d in weatherData.iterrows():
            ...
            #get generative model parameters here - will need to be added to the reicosky algo
            for time in range(100,2401,100):
                ...
                #writeData(OUTPUT_FP,index,time-70,halfTemp,halfRain,COMMENT)
                ...
                #writeData(OUTPUT_FP,index,time,hourTemp,hourRain,COMMENT)
